        ...
        return (
            <Fragment>
                <nav id="push" className={this.state.scroll > this.state.top ? "sticky" : ""}>
                    <div className="nav-wrapper">
                        ...
                        <ul className="right hide-on-med-and-down links">
                            ...
                            <li className="link"><NavLink to="/activities">Activities</NavLink></li>
                            <li className="link"><NavLink to="/pastoralTeam">Pastoral Team</NavLink></li>
                            <li className="link contact"><NavLink to="/contact">Contact</NavLink></li>
                            <li className="link"><NavLink to="/pastoralTeam">Find Us</NavLink></li>
                        </ul>
                    </div>
                </nav>
                ...
                <ul id="mobile-menu" className="sidenav">
                    ...
                    <li className="mobile-link contact"><NavLink activeClassName="active-page" to="/contact">Contact</NavLink></li>
